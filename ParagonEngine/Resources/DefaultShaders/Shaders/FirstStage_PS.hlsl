...
POut1st PS_MAIN(VOut1st input)
{
	...
	//output.pout1st_RT0 = float4(1.0f, 0.0f, 0.0f, 1.0f);
	//output.pout1st_RT1 = float4(1.0f, 0.0f, 0.0f, 1.0f);
	//output.pout1st_RT2 = float4(1.0f, 0.0f, 0.0f, 1.0f);
	//output.pout1st_RT3 = float4(1.0f, 0.0f, 0.0f, 1.0f);
	//output.pout1st_RT4 = float4(1.0f, 0.0f, 0.0f, 1.0f);
	//output.pout1st_Depth = 1.0f;
