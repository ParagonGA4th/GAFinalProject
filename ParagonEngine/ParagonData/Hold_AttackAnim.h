...
{
	class Hold_AttackAnim : public BT::SyncActionNode, public BasePgBtNode
	{
	public:
		Hold_AttackAnim(const std::string& name, const BT::NodeConfiguration& config);
		virtual ~Hold_AttackAnim() = default;
		...
		static BT::PortsList providedPorts()
		{
			...
			tRet.insert(BT::BidirectionalPort<int>("_animFlag"));
