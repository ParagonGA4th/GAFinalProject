...
namespace Pg::DataScript
{
	...
	class WaspSkillAttack : public ScriptInterface<WaspSkillAttack>
	{
		DEFINE_PARAGON_SCRIPT(WaspSkillAttack);
	public:
		WaspSkillAttack(Pg::Data::GameObject* obj);
	...
	public:
		...
		BEGIN_VISITABLES(Pg::DataScript::WaspSkillAttack);
