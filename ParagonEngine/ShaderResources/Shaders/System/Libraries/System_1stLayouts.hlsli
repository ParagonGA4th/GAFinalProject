...
struct Vin1stStatic
{
    ...
    uint    vin1st_MaterialID   : MATERIALID;
...
struct VOut1st
{
    ...
    uint    vout1st_MaterialID  : MATERIALID;
...
struct POut1st //RGBA
{
    ...
    float4 pout1st_RT4 : SV_Target4; //RT4 :  Object ID (x), Material ID (y), LightMap Texture UV Coords (zw)
