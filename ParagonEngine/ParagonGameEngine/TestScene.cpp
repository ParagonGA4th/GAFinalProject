...
void Pg::Engine::TestScene::Initialize()
{
	...
	tObj2->GetComponent<BoxCollider>()->SetScaleOffset({ 2.0f, 2.0f, 2.0f });
	...
	tObj2_1->GetComponent<BoxCollider>()->SetScaleOffset({ 2.0f, 2.0f, 2.0f });
	...
	tObj2_2->GetComponent<BoxCollider>()->SetScaleOffset({ 2.0f, 2.0f, 2.0f });
