...
void Pg::Engine::TestScene::Initialize()
{
	...
	tObj7->GetComponent<Transform>()->_rotation = tObj7->GetComponent<Transform>()->EulerToQuaternion(0.f, 0.f, 0.f);
	...
	tLight->GetComponent<Transform>()->_position = { 0.f, 0.f, 0.f };
	...
	tLight2->GetComponent<Transform>()->_position = { 0.f, 2.0f, 0.f };
...
//tLight2_1->GetComponent<Transform>()->_position = { -3.f, 0.f, 0.f });
...
//tLight3->GetComponent<Transform>()->_position = { 5.0f, 5.0f, 5.0f });
...
tLight4->GetComponent<Transform>()->_position = { 0.0f, 5.0f, 0.0f };
...
tObj8->GetComponent<Transform>()->_position = { 10.f, 140.f, 0.f };
...
tObj9->GetComponent<Transform>()->_position = { 10.0f, 100.f, 0.f };
...
tText_1->GetComponent<Transform>()->_position = { 10.0f, 250.f, 0.f };
...
tObj10->GetComponent<Transform>()->_position = { 10.0f, 10.f, 0.f };
...
tText_2->GetComponent<Transform>()->_position = { 10.0f, 350.f, 0.f };
