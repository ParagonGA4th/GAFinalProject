...
{
	class Test_CSync_ChooseNewDir : public BT::SyncActionNode, public BasePgBtNode
	{
	public:
		//BehaviorTree 필수 요구 사항.
		Test_CSync_ChooseNewDir(const std::string& name, const BT::NodeConfiguration& config) :
			BT::SyncActionNode(name, config) {}
		virtual ~Test_CSync_ChooseNewDir() = default;
