...
namespace Pg::Engine::Physic
{
	...
	public:
		...
		PARAGON_ENGINE_DLL Pg::Data::Collider* MakeRayCast(Pg::Math::PGFLOAT3 tOrigin, Pg::Math::PGFLOAT3 tDir, float tLength, Pg::Math::PGFLOAT3& outHitPoint, int* bType, bool detectTriggers, Pg::Data::Enums::eLayerMask excludeLayer);
