...
namespace Pg::Engine::Physic
{
	...
	void PhysicSystem::Initialize(Pg::Engine::DebugSystem* debugSystem)
	{
		...
		//LayerMask (Pg::Data) 내부 활용해서 CollisionLayer를 설정하는 부분.
		{
			...
			Pg::Engine::PgLayer::SetCollisionData(LAYER_DEFAULT, { LAYER_DEFAULT, LAYER_PLAYER, LAYER_MONSTER, LAYER_PROJECTILES });
			Pg::Engine::PgLayer::SetCollisionData(LAYER_PLAYER, { LAYER_DEFAULT, LAYER_MAP, LAYER_BOSS });
			Pg::Engine::PgLayer::SetCollisionData(LAYER_MONSTER, { LAYER_DEFAULT, LAYER_MONSTER, LAYER_PROJECTILES, LAYER_MAP });
			Pg::Engine::PgLayer::SetCollisionData(LAYER_BOSS, { LAYER_DEFAULT, LAYER_PLAYER, LAYER_MONSTER, LAYER_PROJECTILES, LAYER_MAP });
