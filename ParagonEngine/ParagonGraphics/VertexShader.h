...
namespace Pg::Graphics
{
	...
	public:
		...
		VertexShader(Pg::Data::Enums::eAssetDefine define, const std::string& filePath, D3D11_INPUT_ELEMENT_DESC* vertexDesc);
		VertexShader(Pg::Data::Enums::eAssetDefine define, const std::string& filePath);
