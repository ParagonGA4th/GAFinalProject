...
{
	class TwoTextureEffect3D : public DirectX::IEffect, public DirectX::IEffectMatrices, public BaseCustomEffect
	{
	public:
		explicit TwoTextureEffect3D(ID3D11Device* device, VERenderingSet* veSet);
		...
		virtual unsigned int GetTextureCount() override { return 2; };
	};
}
