...
namespace Pg::Graphics
{
	...
	void LayoutDefine::CreateInstanced1stLayout()
	{
		...
		D3D11_INPUT_ELEMENT_DESC vin1stInstancedDesc[] =
		{
			...
			{"OBJECTID",	0, DXGI_FORMAT_R32_UINT,			2, 0,	D3D11_INPUT_PER_INSTANCE_DATA,	1},
			{"MATERIALID",	0, DXGI_FORMAT_R32_UINT,			2, 4,	D3D11_INPUT_PER_INSTANCE_DATA,	1},
			{"TRANSFORM",	0, DXGI_FORMAT_R32G32B32A32_FLOAT,	2, 8,	D3D11_INPUT_PER_INSTANCE_DATA,	1},
			{"TRANSFORM",	1, DXGI_FORMAT_R32G32B32A32_FLOAT,	2, 24,	D3D11_INPUT_PER_INSTANCE_DATA,	1},
			{"TRANSFORM",	2, DXGI_FORMAT_R32G32B32A32_FLOAT,	2, 40,	D3D11_INPUT_PER_INSTANCE_DATA,	1},
			{"TRANSFORM",	3, DXGI_FORMAT_R32G32B32A32_FLOAT,	2, 56,	D3D11_INPUT_PER_INSTANCE_DATA,	1}
		};
