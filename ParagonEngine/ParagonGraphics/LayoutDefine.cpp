...
namespace Pg::Graphics
{
	...
	void LayoutDefine::CreateSkinned1stLayout()
	{
		...
		D3D11_INPUT_ELEMENT_DESC vin1stSkinnedDesc[] =
		{
			...
			{"TEXCOORD",		0, DXGI_FORMAT_R32G32_FLOAT,		0, 56,	D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"TEXCOORD",		1, DXGI_FORMAT_R32G32_FLOAT,		0, 64,	D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BLENDINDICES",	0, DXGI_FORMAT_R32_UINT,			0, 72,	D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BLENDINDICES",	1, DXGI_FORMAT_R32_UINT,			0, 76,	D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BLENDINDICES",	2, DXGI_FORMAT_R32_UINT,			0, 80,	D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BLENDINDICES",	3, DXGI_FORMAT_R32_UINT,			0, 84,	D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BLENDWEIGHT",		0, DXGI_FORMAT_R32_FLOAT,			0, 88,	D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BLENDWEIGHT",		1, DXGI_FORMAT_R32_FLOAT,			0, 92,	D3D11_INPUT_PER_VERTEX_DATA, 0},
			{"BLENDWEIGHT",		2, DXGI_FORMAT_R32_FLOAT,			0, 96,	D3D11_INPUT_PER_VERTEX_DATA, 0}
		};
