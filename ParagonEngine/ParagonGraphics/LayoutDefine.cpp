...
namespace Pg::Graphics
{
	...
	void LayoutDefine::CreateStatic1stLayout()
	{
		...
		D3D11_INPUT_ELEMENT_DESC vin1stStaticDesc[] =
		{
			...
			{"MESH_MATID",	0, DXGI_FORMAT_R32_UINT,			0, 52,	D3D11_INPUT_PER_VERTEX_DATA, 0},
	...
	LayoutDefine::Vin1stStatic::Vin1stStatic(DirectX::XMFLOAT3 posVal) :
		...
		_color(1.0f, 0.0f, 0.0f), _meshMatID(0), _tex(0.f, 0.f), _lightmapUV(0.f, 0.f), _alpha(0.f), _uvSet2(0.f, 0.f)
	{
		//
	}
